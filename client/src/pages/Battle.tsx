...
import { Swords, ChevronRight, Trophy, SkipForward, Music2, Zap } from "lucide-react";
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === "result" && battle && voteResult && winnerTrack && (
          ...
          >
            ...
            {/* Vote tally */}
            <div className="flex items-center gap-8 py-4 border-y border-white/5 w-full justify-center">
              <div className="text-center">
                <p className="text-2xl font-bold text-primary" data-testid="text-votes-a">{voteResult.trackAVotes}</p>
                <p className="text-[9px] uppercase tracking-widest text-zinc-600 mt-0.5">{battle.trackA.title}</p>
              </div>
              <div className="text-zinc-700 font-bold">VS</div>
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-400" data-testid="text-votes-b">{voteResult.trackBVotes}</p>
                <p className="text-[9px] uppercase tracking-widest text-zinc-600 mt-0.5">{battle.trackB.title}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3.5 border border-primary/40 bg-primary/10 hover:bg-primary/25 text-primary text-[11px] font-bold uppercase tracking-[0.25em] rounded-sm transition-all"
              >
              ...
              <button
                ...
                className="flex-1 py-3.5 border border-white/10 text-zinc-500 hover:text-white hover:border-white/20 text-[11px] font-bold uppercase tracking-[0.25em] rounded-sm transition-all"
              >
                Change Genre
              </button>
            </div>
